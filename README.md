...
<h3 align="center">AltherA-Landing-Page</h3>
  ...
  <p align="center">
    project_description
    <br />
    <a href="https://github.com/exagonsoft/AltherA-Landing-Page"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://github.com/exagonsoft/AltherA-Landing-Page">View Demo</a>
    ·
    <a href="https://github.com/exagonsoft/AltherA-Landing-Page/issues">Report Bug</a>
    ·
    <a href="https://github.com/exagonsoft/AltherA-Landing-Page/issues">Request Feature</a>
  </p>
</div>
...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `exagonsoft`, `AltherA-Landing-Page`, `twitter_handle`, `linkedin_username`, `email_client`, `email`, `AltherA-Landing-Page`, `project_description`
...
2. Clone the repo
   ```sh
   git clone https://github.com/exagonsoft/AltherA-Landing-Page.git
   ```
...
See the [open issues](https://github.com/exagonsoft/AltherA-Landing-Page/issues) for a full list of proposed features (and known issues).
...
Project Link: [https://github.com/exagonsoft/AltherA-Landing-Page](https://github.com/exagonsoft/AltherA-Landing-Page)
